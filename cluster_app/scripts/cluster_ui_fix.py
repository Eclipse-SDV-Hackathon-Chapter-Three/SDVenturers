"""
    ...
    @attentions:
        - Normal mode -> green checkbox, no warning
        - Restricted mode -> red checkbox + blinking warning text
        - If driver returns to normal mode, blinking stops immediately
"""
...
class ClusterUI:
    def __init__(self, root):
        ...
        # Canvas
        self.canvas = tk.Canvas(root, width=670, height=251,
    ...
    def draw_checkbox(self, mode):
        """Draw checkbox according to mode"""
...
def on_message(client, userdata, msg):
    try:
        ...
        if mode_value == "normal":
            ...
            app.root.after(0, app.stop_blink)   # stop warning immediately
